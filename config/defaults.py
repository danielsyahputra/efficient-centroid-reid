...
_C.INPUT.PADDING = 10
# Ranom probability for LGT
_C.INPUT.LGT_PROB = 0.5
# Whether or not to use LGT
_C.INPUT.USE_LGT = False
# Whether or not to use LGPR
_C.INPUT.USE_LGPR = False
# Whether or not to use GGPR
_C.INPUT.USE_GGPR = False
# Whether or not to use Fuse_RGB_Gray_Sketch
_C.INPUT.USE_FUSE_RGB = False
...
_C.OUTPUT_DIR = ""
# Set filename for profiling
_C.PROFILER_FILENAME = ""
